...
public class ArmillaryRecipeWrapper implements IRecipeWrapper
{
    private List<ItemStack> inputStacks;
    private ItemStack output;

    public ArmillaryRecipeWrapper(ArmillaryRecipes.ArmillaryRecipe recipe)
    {
        inputStacks = new ArrayList<ItemStack>();

        inputStacks.add(recipe.input);

        for(ItemStack is : recipe.additionalChanceInputs)
        {
            inputStacks.add(is);
        }
