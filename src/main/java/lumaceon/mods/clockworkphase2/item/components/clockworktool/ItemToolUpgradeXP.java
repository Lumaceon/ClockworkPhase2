...
public class ItemToolUpgradeXP extends ItemClockworkPhase implements IToolUpgrade
{
    public ItemToolUpgradeXP(int maxStack, int maxDamage, String unlocalizedName) {
