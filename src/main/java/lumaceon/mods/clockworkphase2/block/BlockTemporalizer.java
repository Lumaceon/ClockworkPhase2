...
public class BlockTemporalizer extends BlockClockworkPhaseSided implements ITileEntityProvider
{
    public BlockTemporalizer(Material blockMaterial, String unlocalizedName) {
