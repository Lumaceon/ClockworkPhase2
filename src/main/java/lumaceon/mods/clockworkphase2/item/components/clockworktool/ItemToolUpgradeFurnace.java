...
public class ItemToolUpgradeFurnace extends ItemClockworkPhase implements IToolUpgrade
{
    public ItemToolUpgradeFurnace(int maxStack, int maxDamage, String unlocalizedName) {
