...
public class ItemTimestreamSilkyHarvest extends ItemClockworkPhase implements IToolTimestreamPassive
{
    public ItemTimestreamSilkyHarvest(int maxStack, int maxDamage, String unlocalizedName) {
    ...
    public long getTimeSandCostPerApplication(ItemStack item) {
        return TimeConverter.MINUTE * 20;
    }
