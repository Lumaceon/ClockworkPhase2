 ...
 */
public class MapGenOceanMonumentDeadzone extends StructureOceanMonument
{
    StructureOceanMonument childGen;

    public MapGenOceanMonumentDeadzone(StructureOceanMonument base) {
        this.childGen = base;
    }
