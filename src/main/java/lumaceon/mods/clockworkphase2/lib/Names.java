...
/**
 * Class for sorting unlocalized names in one place.
 */
public class Names
{
    public class BLOCK
    ...
    public class ITEM
    {
        ...
        public static final String CLOCKWORK_CORE = "clockwork_core";
        ...
        public static final String GEAR_GOLD = "gold_gear";
