...
public class ItemBlockClockworkBrewery extends ItemBlock implements IAssemblable, IClockworkConstruct
{
    public ItemBlockClockworkBrewery(Block p_i45328_1_) {
        super(p_i45328_1_);
    }
