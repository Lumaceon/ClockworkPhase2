...
public class BlockLifeformReconstructor extends BlockClockworkMachine
{
    public BlockLifeformReconstructor(Material blockMaterial, String name) {
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileLifeformReconstructor();
    }
}
