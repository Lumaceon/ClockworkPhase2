...
public class TimezoneFunctionConstructorCapacitor extends TimezoneFunctionConstructor
{
    public TimezoneFunctionConstructorCapacitor(TimezoneFunctionType type) {
        super(type, 2);
    }
