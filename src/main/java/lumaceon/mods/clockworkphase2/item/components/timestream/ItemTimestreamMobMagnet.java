...
public class ItemTimestreamMobMagnet extends ItemClockworkPhase implements ITimezoneTimestream
{
    public ItemTimestreamMobMagnet(int maxStack, int maxDamage, String unlocalizedName) {
    ...
    public ResourceLocation getGlyphTexture(ItemStack item) {
        return Textures.GLYPH.BASE_GLYPH;
    }
}
