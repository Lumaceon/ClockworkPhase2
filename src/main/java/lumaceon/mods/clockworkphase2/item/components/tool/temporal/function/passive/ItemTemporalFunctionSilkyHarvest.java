...
public class ItemTemporalFunctionSilkyHarvest extends ItemTemporalFunction
{
    public ItemTemporalFunctionSilkyHarvest(int maxStack, int maxDamage, String unlocalizedName, boolean isActiveFunction) {
