...
public class ItemTemporalToolModuleSilkHarvest extends ItemClockworkPhase implements ITemporalToolModule
{
    public ItemTemporalToolModuleSilkHarvest(int maxStack, int maxDamage, String unlocalizedName) {
