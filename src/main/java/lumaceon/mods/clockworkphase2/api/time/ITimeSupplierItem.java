 ...
 * need to hold time for themselves and not have it automatically removed should implement ITimeItem instead.
 *
 * (Based off of the RF API - Credits to King Lemming)
 */
public interface ITimeSupplierItem extends ITimeContainer {}