...
public class ChunkProviderSecondAge implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderSecondAge(World worldIn, long p_i45636_2_, boolean p_i45636_4_, String p_i45636_5_)
    {
        {
